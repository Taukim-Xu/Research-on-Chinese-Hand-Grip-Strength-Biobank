...
% We calculate and display the correlation between height, weight, and HGS 
% for DH.
...
Color_2 = [72 192 170]/255;
Color_3 = [69 105 144]/255;
...
% Height VS HGS of DH
R_Height_HGS_DH_Female = [My_Corr(Female_data_6(:,1),Female_data_6(:,6)) My_Corr(Female_data_7(:,1),Female_data_7(:,6)) My_Corr(Female_data_8(:,1),Female_data_8(:,6)) ...
    My_Corr(Female_data_9(:,1),Female_data_9(:,6)) My_Corr(Female_data_10(:,1),Female_data_10(:,6)) My_Corr(Female_data_11(:,1),Female_data_11(:,6)) ...
    My_Corr(Female_data_12(:,1),Female_data_12(:,6)) My_Corr(Female_data_13(:,1),Female_data_13(:,6)) My_Corr(Female_data_14(:,1),Female_data_14(:,6)) ...
    My_Corr(Female_data_15(:,1),Female_data_15(:,6)) My_Corr(Female_data_16(:,1),Female_data_16(:,6)) My_Corr(Female_data_17(:,1),Female_data_17(:,6)) ...
    My_Corr(Female_data_18(:,1),Female_data_18(:,6)) My_Corr(Female_data_19(:,1),Female_data_19(:,6)) My_Corr(Female_data_20(:,1),Female_data_20(:,6)) ...
    My_Corr(Female_data_21(:,1),Female_data_21(:,6))];
% Weight VS HGS of DH
R_Weight_HGS_DH_Female = [My_Corr(Female_data_6(:,2),Female_data_6(:,6)) My_Corr(Female_data_7(:,2),Female_data_7(:,6)) My_Corr(Female_data_8(:,2),Female_data_8(:,6)) ...
    My_Corr(Female_data_9(:,2),Female_data_9(:,6)) My_Corr(Female_data_10(:,2),Female_data_10(:,6)) My_Corr(Female_data_11(:,2),Female_data_11(:,6)) ...
    My_Corr(Female_data_12(:,2),Female_data_12(:,6)) My_Corr(Female_data_13(:,2),Female_data_13(:,6)) My_Corr(Female_data_14(:,2),Female_data_14(:,6)) ...
    My_Corr(Female_data_15(:,2),Female_data_15(:,6)) My_Corr(Female_data_16(:,2),Female_data_16(:,6)) My_Corr(Female_data_17(:,2),Female_data_17(:,6)) ...
    My_Corr(Female_data_18(:,2),Female_data_18(:,6)) My_Corr(Female_data_19(:,2),Female_data_19(:,6)) My_Corr(Female_data_20(:,2),Female_data_20(:,6)) ...
    My_Corr(Female_data_21(:,2),Female_data_21(:,6))];
...
% Height VS HGS of DH
R_Height_HGS_DH_Male = [My_Corr(Male_data_6(:,1),Male_data_6(:,6)) My_Corr(Male_data_7(:,1),Male_data_7(:,6)) My_Corr(Male_data_8(:,1),Male_data_8(:,6)) ...
    My_Corr(Male_data_9(:,1),Male_data_9(:,6)) My_Corr(Male_data_10(:,1),Male_data_10(:,6)) My_Corr(Male_data_11(:,1),Male_data_11(:,6)) ...
    My_Corr(Male_data_12(:,1),Male_data_12(:,6)) My_Corr(Male_data_13(:,1),Male_data_13(:,6)) My_Corr(Male_data_14(:,1),Male_data_14(:,6)) ...
    My_Corr(Male_data_15(:,1),Male_data_15(:,6)) My_Corr(Male_data_16(:,1),Male_data_16(:,6)) My_Corr(Male_data_17(:,1),Male_data_17(:,6)) ...
    My_Corr(Male_data_18(:,1),Male_data_18(:,6)) My_Corr(Male_data_19(:,1),Male_data_19(:,6)) My_Corr(Male_data_20(:,1),Male_data_20(:,6)) ...
    My_Corr(Male_data_21(:,1),Male_data_21(:,6))];
% Weight VS HGS of DH
R_Weight_HGS_DH_Male = [My_Corr(Male_data_6(:,2),Male_data_6(:,6)) My_Corr(Male_data_7(:,2),Male_data_7(:,6)) My_Corr(Male_data_8(:,2),Male_data_8(:,6)) ...
    My_Corr(Male_data_9(:,2),Male_data_9(:,6)) My_Corr(Male_data_10(:,2),Male_data_10(:,6)) My_Corr(Male_data_11(:,2),Male_data_11(:,6)) ...
    My_Corr(Male_data_12(:,2),Male_data_12(:,6)) My_Corr(Male_data_13(:,2),Male_data_13(:,6)) My_Corr(Male_data_14(:,2),Male_data_14(:,6)) ...
    My_Corr(Male_data_15(:,2),Male_data_15(:,6)) My_Corr(Male_data_16(:,2),Male_data_16(:,6)) My_Corr(Male_data_17(:,2),Male_data_17(:,6)) ...
    My_Corr(Male_data_18(:,2),Male_data_18(:,6)) My_Corr(Male_data_19(:,2),Male_data_19(:,6)) My_Corr(Male_data_20(:,2),Male_data_20(:,6)) ...
    My_Corr(Male_data_21(:,2),Male_data_21(:,6))];
...
XX = 6:0.1:21;
YY = fitobject(XX);
HHHH6 = plot(XX,YY,'LineWidth',My_LineWidth,'Color',Color_1);
HH6 = plot(x_data,y_data,'o','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',Color_1,'MarkerFaceColor','w');

x_data = Age;
y_data = R_Height_HGS_DH_Female; % Height VS HGS of DH
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 6:0.1:21;
YY = fitobject(XX);
HHHH3 = plot(XX,YY,'LineWidth',My_LineWidth,'Color',Color_2);
HH3 = plot(x_data,y_data,'o','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',Color_2,'MarkerFaceColor','w');

x_data = Age;
y_data = R_Weight_HGS_DH_Female; % Weight VS HGS of DH
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 6:0.1:21;
YY = fitobject(XX);
HHHH5 = plot(XX,YY,'LineWidth',My_LineWidth,'Color',Color_3);
HH5 = plot(x_data,y_data,'o','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize,'Color',Color_3,'MarkerFaceColor','w');
...
x_data = Age;
y_data = R_Height_HGS_DH_Male; % Height VS HGS of DH
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 6:0.1:21;
YY = fitobject(XX);
HHHH3 = plot(XX,YY,'LineWidth',My_LineWidth,'Color',Color_2);
...
x_data = Age;
y_data = R_Weight_HGS_DH_Male; % Weight VS HGS of DH
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 6:0.1:21;
YY = fitobject(XX);
HHHH5 = plot(XX,YY,'LineWidth',My_LineWidth,'Color',Color_3);
...
Legend = legend([HHHH1 HHHH2 HHHH3],'FCF VS mHGS for DH','Height VS mHGS','Weight VS mHGS');
set(Legend,'Box','off')
