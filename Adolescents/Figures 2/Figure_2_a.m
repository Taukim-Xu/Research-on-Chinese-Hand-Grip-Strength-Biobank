...
% We calculate the correlation coefficients between DH and NDH.
% FCF of DH VS FCF of NDH, HGS of DH VS HGS of NDH
...
% FCF of DH VS FCF of NDH, HGS of DH VS HGS of NDH
%% For female
R_FCF_DH_FCF_NDH_Female = [My_Corr(Female_data_6(:,3),Female_data_6(:,4)) My_Corr(Female_data_7(:,3),Female_data_7(:,4)) My_Corr(Female_data_8(:,3),Female_data_8(:,4)) ...
    My_Corr(Female_data_9(:,3),Female_data_9(:,4)) My_Corr(Female_data_10(:,3),Female_data_10(:,4)) My_Corr(Female_data_11(:,3),Female_data_11(:,4)) ...
    My_Corr(Female_data_12(:,3),Female_data_12(:,4)) My_Corr(Female_data_13(:,3),Female_data_13(:,4)) My_Corr(Female_data_14(:,3),Female_data_14(:,4)) ...
    My_Corr(Female_data_15(:,3),Female_data_15(:,4)) My_Corr(Female_data_16(:,3),Female_data_16(:,4)) My_Corr(Female_data_17(:,3),Female_data_17(:,4)) ...
    My_Corr(Female_data_18(:,3),Female_data_18(:,4)) My_Corr(Female_data_19(:,3),Female_data_19(:,4)) My_Corr(Female_data_20(:,3),Female_data_20(:,4)) ...
    My_Corr(Female_data_21(:,3),Female_data_21(:,4))];

R_HGS_DH_HGS_NDH_Female = [My_Corr(Female_data_6(:,6),Female_data_6(:,7)) My_Corr(Female_data_7(:,6),Female_data_7(:,7)) My_Corr(Female_data_8(:,6),Female_data_8(:,7)) ...
    My_Corr(Female_data_9(:,6),Female_data_9(:,7)) My_Corr(Female_data_10(:,6),Female_data_10(:,7)) My_Corr(Female_data_11(:,6),Female_data_11(:,7)) ...
    My_Corr(Female_data_12(:,6),Female_data_12(:,7)) My_Corr(Female_data_13(:,6),Female_data_13(:,7)) My_Corr(Female_data_14(:,6),Female_data_14(:,7)) ...
    My_Corr(Female_data_15(:,6),Female_data_15(:,7)) My_Corr(Female_data_16(:,6),Female_data_16(:,7)) My_Corr(Female_data_17(:,6),Female_data_17(:,7)) ...
    My_Corr(Female_data_18(:,6),Female_data_18(:,7)) My_Corr(Female_data_19(:,6),Female_data_19(:,7)) My_Corr(Female_data_20(:,6),Female_data_20(:,7)) ...
    My_Corr(Female_data_21(:,6),Female_data_21(:,7))];
%% For male
R_FCF_DH_FCF_NDH_Male = [My_Corr(Male_data_6(:,3),Male_data_6(:,4)) My_Corr(Male_data_7(:,3),Male_data_7(:,4)) My_Corr(Male_data_8(:,3),Male_data_8(:,4)) ...
    My_Corr(Male_data_9(:,3),Male_data_9(:,4)) My_Corr(Male_data_10(:,3),Male_data_10(:,4)) My_Corr(Male_data_11(:,3),Male_data_11(:,4)) ...
    My_Corr(Male_data_12(:,3),Male_data_12(:,4)) My_Corr(Male_data_13(:,3),Male_data_13(:,4)) My_Corr(Male_data_14(:,3),Male_data_14(:,4)) ...
    My_Corr(Male_data_15(:,3),Male_data_15(:,4)) My_Corr(Male_data_16(:,3),Male_data_16(:,4)) My_Corr(Male_data_17(:,3),Male_data_17(:,4)) ...
    My_Corr(Male_data_18(:,3),Male_data_18(:,4)) My_Corr(Male_data_19(:,3),Male_data_19(:,4)) My_Corr(Male_data_20(:,3),Male_data_20(:,4)) ...
    My_Corr(Male_data_21(:,3),Male_data_21(:,4))];

R_HGS_DH_HGS_NDH_Male = [My_Corr(Male_data_6(:,6),Male_data_6(:,7)) My_Corr(Male_data_7(:,6),Male_data_7(:,7)) My_Corr(Male_data_8(:,6),Male_data_8(:,7)) ...
    My_Corr(Male_data_9(:,6),Male_data_9(:,7)) My_Corr(Male_data_10(:,6),Male_data_10(:,7)) My_Corr(Male_data_11(:,6),Male_data_11(:,7)) ...
    My_Corr(Male_data_12(:,6),Male_data_12(:,7)) My_Corr(Male_data_13(:,6),Male_data_13(:,7)) My_Corr(Male_data_14(:,6),Male_data_14(:,7)) ...
    My_Corr(Male_data_15(:,6),Male_data_15(:,7)) My_Corr(Male_data_16(:,6),Male_data_16(:,7)) My_Corr(Male_data_17(:,6),Male_data_17(:,7)) ...
    My_Corr(Male_data_18(:,6),Male_data_18(:,7)) My_Corr(Male_data_19(:,6),Male_data_19(:,7)) My_Corr(Male_data_20(:,6),Male_data_20(:,7)) ...
    My_Corr(Male_data_21(:,6),Male_data_21(:,7))];
%% We show the results.
Age = 6:21;
figure;
% For female
...
XX_Fill_1 = [5.5 12 12 5.5]; % primary school
YY_Fill_1 = [0.505 0.505 1 1];
...
x_data = Age;
y_data = R_FCF_DH_FCF_NDH_Female; % FCF of DH VS FCF of NDH
...
x_data = Age;
y_data = R_HGS_DH_HGS_NDH_Female; % HGS of DH VS HGS of NDH
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 6:0.1:21;
YY = fitobject(XX);
...
x_data = Age;
y_data = R_FCF_DH_FCF_NDH_Male; % FCF of DH VS FCF of NDH
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 6:0.1:21;
YY = fitobject(XX);
HHHH1 = plot(XX,YY,'LineWidth',My_LineWidth,'Color',Color_1);
...
x_data = Age;
y_data = R_HGS_DH_HGS_NDH_Male; % HGS of DH VS HGS of NDH
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 6:0.1:21;
YY = fitobject(XX);
HHHH2 = plot(XX,YY,'LineWidth',My_LineWidth,'Color',Color_2);
...
Legend = legend([HHHH1 HHHH2],'DH VS NDH for FCF','DH VS NDH for mHGS');
set(Legend,'Box','off')
