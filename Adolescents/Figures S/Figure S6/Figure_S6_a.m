...
% coefficients a and b changing with age for the BCCPDS.
...
%
%% Loading data
load('Coefficient_a_and_b_BCCPDS.mat')
...
Legend = legend([HH1 HH2],'Female','Male','Location','southeast');
...
x_data = Age_BCCPDS;
y_data = Coefficient_a_Female_BCCPDS;
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 5.5:0.02:21.5;
YY = fitobject(XX);
X = YY;
...
x_data = Age_BCCPDS;
y_data = Coefficient_a_Male_BCCPDS;
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 5.5:0.02:21.5;
YY = fitobject(XX);
X = YY;
...
% Maximum
plot(0.124844,0.863129,'o','color','r','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize);
plot(0.124844,0.536921,'o','color','r','LineWidth',My_LineWidth,'MarkerSize',My_MarkerSize);
...
x_data = Age_BCCPDS;
y_data = Coefficient_b_Female_BCCPDS;
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 5.5:0.02:21.5;
YY = fitobject(XX);
X = YY;
...
x_data = Age_BCCPDS;
y_data = Coefficient_b_Male_BCCPDS;
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 5.5:0.02:21.5;
YY = fitobject(XX);
X = YY;
