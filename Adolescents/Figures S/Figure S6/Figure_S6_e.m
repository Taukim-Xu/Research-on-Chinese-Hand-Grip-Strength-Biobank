%% Source codes for Figure S6(e).
% We use Fourier transform to calculate the frequency spectrum of 
% coefficients a and b changing with age for the KSPF.
...
%
%% Loading data
load('Coefficient_a_and_b_KSPF.mat')
...
x_data = Age_KSPF;
y_data = Coefficient_a_Female_KSPF;
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 10.5:0.02:21.5;
YY = fitobject(XX);
X = YY;
...
x_data = Age_KSPF;
y_data = Coefficient_a_Male_KSPF;
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 10.5:0.02:21.5;
YY = fitobject(XX);
X = YY;
...
x_data = Age_KSPF;
y_data = Coefficient_b_Female_KSPF;
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 10.5:0.02:21.5;
YY = fitobject(XX);
X = YY;
...
x_data = Age_KSPF;
y_data = Coefficient_b_Male_KSPF;
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 10.5:0.02:21.5;
YY = fitobject(XX);
X = YY;
