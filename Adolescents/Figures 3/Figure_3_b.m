...
% We calculate the coefficients a and b in the 1 = c/HGS + d*Height.
...
Edgealpha = 0;
Alpha = 1; % transparency of the filled area
%% Colors
...
%% The coefficient of c and d
Coefficient_c_Female_Ours = [];
Coefficient_d_Female_Ours = [];
Coefficient_c_Male_Ours = [];
Coefficient_d_Male_Ours = [];
...
title('Female');
xlabel('Height*mHGS (Kg.m)');
ylabel('mHGS (Kg)')
xlim([0 80]);
ylim([0 50]);
XX_Text = 75;
YY_Text = 8;
My_text = 'mHGS = c + d*Height*mHGS';
Text = text(XX_Text,YY_Text,My_text,'FontSize',12,'FontName',My_FontName,'HorizontalAlignment','right');

% Aged 6
x_data = Female_data_6(:,1).*Female_data_6(:,6)/100;
...
Coefficient_c_Female_Ours = [Coefficient_c_Female_Ours BB(2)];
Coefficient_d_Female_Ours = [Coefficient_d_Female_Ours BB(1)];

% Aged 7
x_data = Female_data_7(:,1).*Female_data_7(:,6)/100;
...
% Aged 8
x_data = Female_data_8(:,1).*Female_data_8(:,6)/100;
...
% Aged 9
x_data = Female_data_9(:,1).*Female_data_9(:,6)/100;
...
% Aged 10
x_data = Female_data_10(:,1).*Female_data_10(:,6)/100;
...
% Aged 11
x_data = Female_data_11(:,1).*Female_data_11(:,6)/100;
...
% Aged 12
x_data = Female_data_12(:,1).*Female_data_12(:,6)/100;
...
% Aged 13
x_data = Female_data_13(:,1).*Female_data_13(:,6)/100;
...
% Aged 14
x_data = Female_data_14(:,1).*Female_data_14(:,6)/99;
...
% Aged 15
x_data = Female_data_15(:,1).*Female_data_15(:,6)/100;
...
% Aged 16
x_data = Female_data_16(:,1).*Female_data_16(:,6)/100;
...
% Aged 17
x_data = Female_data_17(:,1).*Female_data_17(:,6)/100;
...
% Aged 18
x_data = Female_data_18(:,1).*Female_data_18(:,6)/100;
...
% Aged 19
x_data = Female_data_19(:,1).*Female_data_19(:,6)/100;
...
% Aged 20
x_data = Female_data_20(:,1).*Female_data_20(:,6)/100;
...
% Aged 21
x_data = Female_data_21(:,1).*Female_data_21(:,6)/100;
...
% Aged 6
x_data = Male_data_6(:,1).*Male_data_6(:,6)/100;
...
y_temp = BB(2)+BB(1)*x_temp;
plot(x_temp,y_temp,'Color',Color_6,'LineWidth',My_LineWidth);
Coefficient_c_Male_Ours = [Coefficient_c_Male_Ours BB(2)];
Coefficient_d_Male_Ours = [Coefficient_d_Male_Ours BB(1)];

% Aged 7
x_data = Male_data_7(:,1).*Male_data_7(:,6)/100;
...
% Aged 8
x_data = Male_data_8(:,1).*Male_data_8(:,6)/100;
...
% Aged 9
x_data = Male_data_9(:,1).*Male_data_9(:,6)/100;
...
% Aged 10
x_data = Male_data_10(:,1).*Male_data_10(:,6)/100;
...
% Aged 11
x_data = Male_data_11(:,1).*Male_data_11(:,6)/100;
...
% Aged 12
x_data = Male_data_12(:,1).*Male_data_12(:,6)/100;
...
% Aged 13
x_data = Male_data_13(:,1).*Male_data_13(:,6)/100;
...
% Aged 14
x_data = Male_data_14(:,1).*Male_data_14(:,6)/99;
...
% Aged 15
x_data = Male_data_15(:,1).*Male_data_15(:,6)/100;
...
% Aged 16
x_data = Male_data_16(:,1).*Male_data_16(:,6)/100;
...
% Aged 17
x_data = Male_data_17(:,1).*Male_data_17(:,6)/100;
...
% Aged 18
x_data = Male_data_18(:,1).*Male_data_18(:,6)/100;
...
% Aged 19
x_data = Male_data_19(:,1).*Male_data_19(:,6)/100;
...
% Aged 20
x_data = Male_data_20(:,1).*Male_data_20(:,6)/100;
...
% Aged 21
x_data = Male_data_21(:,1).*Male_data_21(:,6)/100;
...
%% We show the results of coefficients c and d
Age = 6:21;
% coefficient c
subplot(2,3,4);
hold on;
...
% We show different school stage
XX_Fill_1 = [5.15 12 12 5.15]; % primary school
YY_Fill_1 = [0.05 0.05 12 12];
...
x_data = Age;
y_data = Coefficient_c_Female_Ours; % For female
...
x_data = Age;
y_data = Coefficient_c_Male_Ours; % For male
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 5.5:0.1:21.5;
YY = fitobject(XX);
...
x_data = Age;
y_data = Coefficient_d_Female_Ours; % For female
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 5.5:0.1:21.5;
YY = fitobject(XX);
H1 = plot(XX,YY,'r','LineWidth',My_LineWidth,'Color',Color_1);
...
x_data = Age;
y_data = Coefficient_d_Male_Ours; % For male
[fitobject,gof] = fit(x_data',y_data','smooth');
XX = 5.5:0.1:21.5;
YY = fitobject(XX);
H2 = plot(XX,YY,'r','LineWidth',My_LineWidth,'Color',Color_2);
...
%% We save the coefficients c and d
%save('Coefficient_c_and_d_Ours.mat','Coefficient_c_Female_Ours','Coefficient_d_Female_Ours','Coefficient_c_Male_Ours','Coefficient_d_Male_Ours');
