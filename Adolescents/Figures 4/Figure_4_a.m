...
xlim([100 200]);
ylim([0 60]);
My_Text1 = text(110,50.5,'mHGS = e1 + m1*Height','FontSize',My_fontSize,'FontName',My_FontName,'HorizontalAlignment','Left');
...
xlim([100 200]);
ylim([0 90]);
My_Text1 = text(110,77,'mHGS = e1 + m1*Height','FontSize',My_fontSize,'FontName',My_FontName,'HorizontalAlignment','Left');
...
xlim([10 110]);
ylim([0 60]);
My_Text1 = text(20,50.5,'mHGS = e2 + m2*Weight','FontSize',My_fontSize,'FontName',My_FontName,'HorizontalAlignment','Left');
...
xlim([10 110]);
ylim([0 90]);
My_Text1 = text(20,77,'mHGS = e2 + m2*Weight','FontSize',My_fontSize,'FontName',My_FontName,'HorizontalAlignment','Left');
